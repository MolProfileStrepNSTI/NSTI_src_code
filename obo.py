...
# module is part of the goenrich package by Jan Rudolph (jdrudolph)
# https://github.com/jdrudolph/goenrich/blob/master/goenrich/obo.py
...
def ontology(file):
    ...
    if isinstance(file, str):
        ...
        if file.endswith('.gz'):
            with gzip.open(file, 'rt') as f_gz:
                f = f_gz.readlines()
